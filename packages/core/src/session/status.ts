...
export async function sessionStatusById(client: GatehouseClient, directory: string, plugin?: PluginInput) {
  ...
  if (typeof client.session.status !== "function") return new Map<string, SessionRuntimeStatus>()
