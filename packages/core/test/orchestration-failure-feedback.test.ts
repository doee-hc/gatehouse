...
import { notifyArchitectOrchestrationFailure } from "../src/orchestration/engine/notify.ts"
import { orchestrationNeedsResume } from "../src/orchestration/lifecycle/resume.ts"
...
export default async function orchestrate(ctx) {
  await ctx.run("leaf", {
    ...
    text: "bad gatehouse_send_message(recipient="ai-writer", message="done")",
  })
}
`
