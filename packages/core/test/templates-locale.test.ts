...
const REQUIRED_EN_RELATIVES = [
  ...
  "prompts/architect/watchdog-skill-verify-record-wake.md",
  "prompts/lead/autopilot-wake.md",
  "prompts/lead/autopilot-enabled.md",
  "prompts/architect/retro-analyst-kickoff.md",
  "prompts/architect/retro-summary.template.md",
  "prompts/architect/architect-summary.template.md",
  "prompts/architect/domain-skill-extract.md",
  "prompts/architect/domain-skill-verify.md",
