...
const REQUIRED_EN_RELATIVES = [
  ...
  "prompts/architect/dispatch-root.md",
  "prompts/architect/dispatch-root-solo.md",
  "prompts/architect/watchdog-root-wake.md",
  "prompts/architect/watchdog-root-wake-solo.md",
