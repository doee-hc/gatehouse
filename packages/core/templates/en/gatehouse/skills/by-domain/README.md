...
- **Timing**: only after {{lead_name}} accepts delivery and runs `gatehouse_mission_retro`; Gatehouse dispatches `.gatehouse/prompts/architect/domain-skill-extract.md` to execution sessions.
