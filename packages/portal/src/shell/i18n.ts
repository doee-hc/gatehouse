...
const messages = {
  ...
  "orch.stepOp.setBrief": { zh: "Brief", en: "Brief" },
  "orch.stepOp.prompt": { zh: "工单", en: "Prompt" },
  "orch.stepOp.wait": { zh: "等待", en: "Wait" },
  "orch.stepOp.waitRollup": { zh: "汇总", en: "Rollup" },
  "orch.stepOp.parallel": { zh: "并行", en: "Parallel" },
  "orch.stepOp.pipeline": { zh: "流水线", en: "Pipeline" },
  "orch.stepOp.phase": { zh: "阶段", en: "Phase" },
  "orch.stepOp.log": { zh: "日志", en: "Log" },
  ...
  "event.retroNodeDone": { zh: "{node} 复盘报告已提交", en: "{node} retro report submitted" },
  "event.retroAllDone": { zh: "任务 {id} 复盘完成", en: "Mission {id} retro completed" },
