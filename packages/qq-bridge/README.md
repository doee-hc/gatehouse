...
WebSocket integration reference: [opencode-im-bridge](https://github.com/ET06731/opencode-im-bridge) (`qq-official-bot` SDK). Gatehouse integration in [`@gatehouse/channels-core`](../channels-core/README.md).
